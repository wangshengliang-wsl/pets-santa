      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-100 dark:border-slate-800 overflow-hidden transition-colors duration-300">
          <div className="p-8 md:p-10">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">{t('welcomeBack')}</h1>
              <p className="text-slate-500 dark:text-slate-400">{t('signInSubtitle')}</p>
            </div>
        ...
        <SignInForm />
            ...
            <div className="flex items-center gap-4 my-6">
              ...
              <span className="text-xs text-slate-400 dark:text-slate-500 font-medium uppercase tracking-widest">{t('or')}</span>
              <div className="flex-1 h-px bg-slate-200 dark:bg-slate-700"></div>
            </div>
