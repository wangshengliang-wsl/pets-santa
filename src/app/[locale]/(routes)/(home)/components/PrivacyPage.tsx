...
const PrivacyPage: React.FC<PrivacyPageProps> = ({ onGoHome }) => {
          ...
          {sections.map((section, index) => (
            ...
            >
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-10 h-10 bg-red-100 dark:bg-red-900/30 rounded-full flex items-center justify-center text-red-600 dark:text-red-400 font-bold">
                  {index + 1}
                </div>
                <div>
